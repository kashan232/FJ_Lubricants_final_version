...
class SaleReturnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $saleReturn = SaleReturn::create([
            ...
            'item_ids' => json_encode($items->pluck('item_id')->toArray()),
            'item_names' => json_encode($items->pluck('item_name')->toArray()),
            'pcs_per_carton' => json_encode($items->pluck('pcs_per_carton')->toArray()),
            'carton_qty' => json_encode($items->pluck('carton_qty')->toArray()),
            'pcs_qty' => json_encode($items->pluck('pcs_qty')->toArray()),
            'rate' => json_encode($items->pluck('rate')->toArray()),
            'discount' => json_encode($items->pluck('discount')->toArray()),
            'total' => json_encode($items->pluck('total')->toArray()),
