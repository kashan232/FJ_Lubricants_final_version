                            ...
                            <table class="table table-bordered align-middle text-center" id="purchaseTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control form-control-lg code" name="code[]" style="width: 180px;" readonly></td>
                                        <td>
...
<script>
    ...
    <tr>
        ...
        <td>
                                            <input type="text" class="form-control form-control-lg code" name="code[]" style="width: 180px;" readonly>
                                        </td>
        <td>
                                            <select class="form-control form-control-lg item-select" name="item[]" style="width: 400px;">
                                                <option>Select Item</option>
