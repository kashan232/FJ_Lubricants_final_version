    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="card p-4 shadow-lg">
                <div class="card-body">
                    <h3 class="card-title text-center fw-bold mb-4 text-primary">PRODUCT PURCHASE REPORT</h3>
                    ...
                    <div class="title mt-4">PRODUCT PURCHASE REPORT</div>

                    <table id="productPurchaseTable">
                        <thead>
                            <tr>
                                <th>SN#</th>
                                <th>Vendor Name</th>
...
<script>
    ...
    document.getElementById("searchLedger").addEventListener("click", function() {
        ...
        fetch("{{ route('get-Product-Purchase-report') }}", {
                method: "POST",
                headers: {
            ...
            .then(data => {
                ...
                let tableBody = document.querySelector("#productPurchaseTable tbody");
                tableBody.innerHTML = "";
                ...
                data.forEach((item) => {
                    ...
                    <tr>
                        ...
                        <td>${item.address} / ${item.city} / ${item.area}</td>
                        <td>${item.item}</td>
